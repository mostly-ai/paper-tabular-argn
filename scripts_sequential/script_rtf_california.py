...
parent_df = pd.read_parquet(dataset_dir / 'california-household-train.parquet')
child_df = pd.read_parquet(dataset_dir / 'california-individual-train.parquet')
join_on = "household_id"
...
parent_samples.to_parquet(f'RTF_california_household.parquet')
child_samples[join_on]=child_samples.index
child_samples.reset_index(drop=True).to_parquet(f'RTF_california_individual.parquet')
